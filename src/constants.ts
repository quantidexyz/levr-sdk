...
export const GET_FACTORY_ADDRESS = (chainId?: number): `0x${string}` | undefined => {
  ...
  return {
    [anvil.id]: process.env.FACTORY_ADDRESS || process.env.NEXT_PUBLIC_LEVR_FACTORY_V1_ANVIL,
...
export const GET_FEE_SPLITTER_ADDRESS = (chainId?: number): `0x${string}` | undefined => {
  ...
  return {
    [anvil.id]:
      process.env.FEE_SPLITTER_ADDRESS || process.env.NEXT_PUBLIC_LEVR_FEE_SPLITTER_V1_ANVIL,
